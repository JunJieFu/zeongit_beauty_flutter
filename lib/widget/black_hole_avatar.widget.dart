...
class BlackHoleAvatarWidget extends StatelessWidget {
  BlackHoleAvatarWidget(this.info, {Key key, this.size = 50.0, this.fit, this.style})
      : super(key: key);

  final UserBlackHoleEntity info;
