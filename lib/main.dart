...
class App extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final info = StorageManager.getJson(KeyConstant.USER_INFO) != null
    ...
    final userGetxCtrl = Get.find<UserGetxCtrl>();
    print(userGetxCtrl.info);
    ...
    return RefreshConfiguration(
      ...
      child: MaterialApp(
        ...
        home: Obx(() => fragmentGetxCtrl.hasInit ? TabPage() : WelcomePage()),
