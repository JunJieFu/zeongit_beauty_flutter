...
pageUserBlackHoleEntityFromJson(PageUserBlackHoleEntity data, Map<String, dynamic> json) {
	if (json['content'] != null) {
		data.content = new List<UserBlackHoleEntity>();
		(json['content'] as List).forEach((v) {
			data.content.add(new UserBlackHoleEntity().fromJson(v));
		});
	}
...
pagePictureBlackHoleEntityFromJson(PagePictureBlackHoleEntity data, Map<String, dynamic> json) {
	if (json['content'] != null) {
		data.content = new List<PictureBlackHoleEntity>();
		(json['content'] as List).forEach((v) {
			data.content.add(new PictureBlackHoleEntity().fromJson(v));
		});
	}
	if (json['pageable'] != null) {
		data.pageable = new PagePageable().fromJson(json['pageable']);
...
pageTagBlackHoleEntityFromJson(PageTagBlackHoleEntity data, Map<String, dynamic> json) {
	if (json['content'] != null) {
		data.content = new List<TagBlackHoleEntity>();
		(json['content'] as List).forEach((v) {
			data.content.add(new TagBlackHoleEntity().fromJson(v));
		});
	}
	if (json['pageable'] != null) {
		data.pageable = new PagePageable().fromJson(json['pageable']);
