...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case PagePictureEntity:
			return pagePictureEntityFromJson(data as PagePictureEntity, json) as T;			case UserInfoEntity:
			return userInfoEntityFromJson(data as UserInfoEntity, json) as T;			case PageableEntity:
			...
			return pageSortFromJson(data as PageSort, json) as T;			case PictureEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case PagePictureEntity:
			return pagePictureEntityToJson(data as PagePictureEntity);			case UserInfoEntity:
			return userInfoEntityToJson(data as UserInfoEntity);			case PageableEntity:
			...
			return pageSortToJson(data as PageSort);			case PictureEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'PagePictureEntity':
			return PagePictureEntity().fromJson(json);			case 'UserInfoEntity':
			return UserInfoEntity().fromJson(json);			case 'PageableEntity':
			return PageableEntity().fromJson(json);			case 'PagePageable':
			return PagePageable().fromJson(json);			case 'PageSort':
			return PageSort().fromJson(json);			case 'PictureEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'PagePictureEntity':
			return List<PagePictureEntity>();			case 'UserInfoEntity':
			return List<UserInfoEntity>();			case 'PageableEntity':
			return List<PageableEntity>();			case 'PagePageable':
			return List<PagePageable>();			case 'PageSort':
			return List<PageSort>();			case 'PictureEntity':
