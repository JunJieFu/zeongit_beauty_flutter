...
import 'package:zeongitbeautyflutter/generated/json/picture_user_entity_helper.dart';
...
class JsonConvert<T> {
  ...
  static _getFromJson<T>(Type type, data, json) {
    switch (type) {			case UserInfoEntity:
			return userInfoEntityFromJson(data as UserInfoEntity, json) as T;			case PictureUserEntity:
			return pictureUserEntityFromJson(data as PictureUserEntity, json) as T;			case PictureEntity:
  ...
  static _getToJson<T>(Type type, data) {
		switch (type) {			case UserInfoEntity:
			return userInfoEntityToJson(data as UserInfoEntity);			case PictureUserEntity:
			return pictureUserEntityToJson(data as PictureUserEntity);			case PictureEntity:
  ...
  static _fromJsonSingle(String type, json) {
    switch (type) {			case 'UserInfoEntity':
			return UserInfoEntity().fromJson(json);			case 'PictureUserEntity':
			return PictureUserEntity().fromJson(json);			case 'PictureEntity':
  ...
  static _getListFromType(String type) {
    switch (type) {			case 'UserInfoEntity':
			return List<UserInfoEntity>();			case 'PictureUserEntity':
			return List<PictureUserEntity>();			case 'PictureEntity':
